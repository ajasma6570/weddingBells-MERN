...
export default function UserBookingCompleted() {
  return (
    ...
    <div className="w-9/12 mx-auto text-center">
      ...
      <p className="text-xl font-semibold py-1">Booking Id: </p>
      ...
      <div className='py-1'>
        <button type="button" className="text-white bg-blue-600 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2">
