...
export default function AccountDetails() {
  ...
  <div className="lg:w-3/6 w-full lg:order-1 order-2 flex flex-col items-center justify-center">
    ...
    <span className="block mt-2 bg-gray-800 hover:bg-gray-500 text-white rounded-md px-2 cursor-pointer">Change Image</span>
      ...
      <div className="">
        ...
        <div className="">
          <div className="my-5">
            ...
            <input value={user.name} className="border border-black rounded-md pl-3 cursor-pointer " readOnly />
          </div>
          <div className="my-5">
            <label>E-mail</label>
            <span className="pl-10 pr-5">:</span>
            <input value={user.email} className="border border-black rounded-md pl-3 cursor-pointer " readOnly />
          </div>
          <div className="my-5">
            <label>Phone</label>
            <span className="pl-10 pr-5">:</span>
            <input value={user.phone} className="border border-black rounded-md pl-3 cursor-pointer " readOnly />
          </div>
          <div className="my-5">
            <label>Address</label>
            <span className="pl-6 pr-6">:</span>
            <input value={user.address} className="border border-black rounded-md pl-3 cursor-pointer " readOnly />
          </div>
          <div className="my-5">
            <label>State</label>
            <span className="pl-12 pr-5">:</span>
            <input value={user.state} className="border border-black rounded-md pl-3 cursor-pointer " readOnly />
          </div>
          <div className="my-5">
            <label>City</label>
            <span className="pl-14 pr-5">:</span>
            <input value={user.city} className="border border-black rounded-md pl-3 cursor-pointer "
            readOnly />
          </div>
          <div className="my-5">
            <label>Pin</label>
            <span className="pl-16 pr-5">:</span>
            <input value={user.pincode} className="border border-black rounded-md pl-3 cursor-pointer" readOnly />          
            </div>
          <div className="my-5">
