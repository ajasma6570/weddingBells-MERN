        ...
        <Link to={`/cateringList/cateringDetail/${catering._id}`}>
              <div className="flex justify-between p-10 gap-8 cursor-pointer" key={index}>
                ...
                <div className="w-6/12">
                  <h1 className='xxs:text-xs xs:text-sm sm:text-md md:text-lg lg:text-2xl font-semibold'>{catering.name}</h1>
                  <p className='text-gray-500 xxs:text-xs xs:text-sm sm:text-md md:text-md lg:text-xl'>{catering.city}, kerala</p>
                  <p className='xxs:text-xs xs:text-sm sm:text-md md:text-base lg:text-xl'>Items : {catering.description}</p>
                  <p className='text-gray-500  xxs:text-xs xs:text-sm sm:text-md md:text-md lg:text-xl'>Min Amount : {catering.minAmount}<small> per head</small></p>
                  <p className='text-gray-500  xxs:text-xs xs:text-sm sm:text-md md:text-md lg:text-xl'>Max Amount : {catering.maxAmount}<small> per head</small></p>
                </div>
              </div>
              </Link>
            ))
