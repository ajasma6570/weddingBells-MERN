...
export default function AdminBusinessEdit() {
    ...
    const [AdminBusinessDetails] = useAdminBusinessDetailsMutation();
    const [AdminBusinessAccDetailsEdit] = useAdminBusinessAccDetailsEditMutation()
    ...
    const handleUpdate = async() => {
        ...
        if (
          ...
          swalFire("Confirm Update").then(async(result)=>{
            if(result.isConfirmed){
              const res= await AdminBusinessAccDetailsEdit({name, email, phone, address, state, city, pincode, userId})
